        ...
        for ser in series[:]:
            for wnt in self.series:
                if wnt['title'] == ser['title']:
                    ...
                    ser['title_format'] = { 'apply_default_format': True }
                    # Update values
                    if 'regex' in wnt:
                        regex = wnt['regex']
                        if 'sonarr' in regex:
                    ...
                    if 'playlistreverse' in wnt:
                        ser['playlistreverse'] = bool(wnt['playlistreverse'])
                    if 'subtitles' in wnt:
                        ser['subtitles'] = True
                    ...
                    if 'title_format' in wnt:
                        title_format = wnt['title_format']

                        ser['title_format'] = wnt['title_format']
                        if 'apply_default_format' in title_format:
                            ser['title_format']['apply_default_format'] = bool(wnt['title_format']['apply_default_format'])
                        if 'remove_quotes' in title_format:
                            ser['title_format']['remove_quotes'] = bool(wnt['title_format']['remove_quotes'])
                        if 'make_ponctuation_optional' in title_format:
                            ser['title_format']['make_ponctuation_optional'] = bool(wnt['title_format']['make_ponctuation_optional'])
                    if 'ytdlp' in wnt:
                        ser['ytdlp_options'] = wnt['ytdlp']
